...
<main class='home_main'>
      ...
      if ($searchValue != "") {
          ...
          echo("<div style='align-content:center'>\n
                  ...
                  <br><br>
                  <label class='default_text' id='DBDescriptiontext'>BactMentha is a database of host-bacteria protein interactions, enriched with 
                  bacterial protein functional annotations, and complemented by <br>protein binding regions that are either described in the literature
                  or computationally inferred using known interaction templates</label>
                  <br><br>");
          displaySearchBarDiv();
          // HELP DISPLAY DIV
          displayHelpDiv();
