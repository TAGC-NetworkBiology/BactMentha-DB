...
<!------------------------------------------------------------------ SECOND FORM ------------------------------------------------------------------>
        ...
        <div class="contact_page_wrapper">
            ...
            <div class="contact_page_subdiv_people_involved">
                <div class="contact_centered_subtitles">Pepole involved:</div><br>
                  
                <div class="centered_text_content">
                    BERGOGNE Lou<br><br>
                    BOUGEANT Mégane<br><br>
                    IANNUCCELLI Marta<br><br>
                    LICATA Luana<br><br>
                    ZANZONI Andreas
                </div><br><br>
            </div>
            ...
            <div class="contact_page_subdiv_contact_issue">
                <div class="contact_centered_subtitles">For any curation issue, please contact :</div><br>
                  
                <div class="centered_text_content">
                    ZANZONI Andreas:
                    <label><u>andreas.zanzoni@univ-amu.fr</u></label>
                    <img src='/static/img/buttons/copy-icon.svg' class='CopyEmailImg' title='Copy email'>
                    <br>
                    LICATA Luana:
                    <label><u>luana.licata@uniroma2.it</u></label>
                    <img src='/static/img/buttons/copy-icon.svg' class='CopyEmailImg' title='Copy email'>
                    <br>
                </div><br><br>

                <div class="contact_centered_subtitles">For any technical issue, please contact :</div><br>
                  
                <div class="centered_text_content">
                    Lou BERGOGNE:
                    <label><u>lou.bergogne@univ-amu.fr</u></label>
                    <img src='/static/img/buttons/copy-icon.svg' class='CopyEmailImg' title='Copy email'>
                    <br>
                </div><br><br>
            </div>
            ...
            <div class="contact_page_subdiv_tools">
                ...
                <div class="centered_text_content">
                    BastionHub:
                    <label><a class='table_link' href='https://bastionhub.erc.monash.edu/'>https://bastionhub.erc.monash.edu/</a></label>
                    <br><br>
                    ELM database:
                    <label><a class='table_link' href='http://elm.eu.org/'>http://elm.eu.org/</a></label>
                    <br><br>
                    IMEx Consortium:
                    <label><a class='table_link' href='https://www.imexconsortium.org/'>https://www.imexconsortium.org/</a></label>
                    <br><br>
                    InterPro database:
                    <label><a class='table_link' href='https://www.ebi.ac.uk/interpro/'>https://www.ebi.ac.uk/interpro/</a></label>
                    <br><br>
                    Mimicint:
                    <label><a class='table_link' href='https://mimicintweb.tagc.univ-amu.fr/'>https://mimicintweb.tagc.univ-amu.fr/</a></label>
                    <br><br>
                    VFDB:
                    <label><a class='table_link' href='https://www.mgc.ac.cn/VFs/'>https://www.mgc.ac.cn/VFs/</a></label>
                    <br><br>
                </div><br><br>
            </div>
