...
class computeMutationsStats():
    ...
    def __init__( self, path_to_createdb:str, db_name:str, db_host_name:str, db_user_name:str, db_pw:str, db_port:str ) -> None:
        ...
        # ATTRIBUTES
        self.saving_path = "/BactMentha/03_Script/04_Website/static/stats/" # path from inside the container
    ...
    def getTotalInteractions( self, taxon_id: str ) -> list:
        ...
        cursor.close()
        temp_table = pd.DataFrame(records, columns=column_names, index=None)
        return temp_table['mnt_interaction_id'].to_list()
