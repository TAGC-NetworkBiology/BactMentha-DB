...
function displayAnnotationButtons(data) {
     ...
     * 
     * Args:
     * - data: a string -> "XXXXX", where X can be '1' or '0' depending on if the mnt_interaction_id
     *   of the line is related to some data in the tables : PA, CC, BR, MI and AF
     * 
     * Return:
     * htmlText: some html to display three buttons in color or in grey
     */
    // For PA: Bacterial Protein Annotations
    if (data[0] != '0') {
        var PA = "<a class='moreInfoBtnLinkPA' title='Bacterial Protein Annotations'><img src='/static/img/buttons/annotations_button.png' class='child_row_button'></a>";
    }
    else {
        var PA = "<a class='moreInfoBtnLinkGrey_pa' title='Bacterial Protein Annotations'><img src='/static/img/buttons/grey_button.png' class='child_row_button'></a>";
    }
    // For CC: Cellular Components
    if (data[1] != '0') {
        var CC = "<a class='moreInfoBtnLinkCC' title='Cellular Components'><img src='/static/img/buttons/cellcomp_button.png' class='child_row_button'></a>";
    }
    else {
        var CC = "<a class='moreInfoBtnLinkGrey_pa' title='Cellular Components'><img src='/static/img/buttons/grey_button.png' class='child_row_button'></a>";
    }
    // For BR: Cellular Components
    if (data[2] != '0') {
        var BR = "<a class='moreInfoBtnLinkBR' title='Binding Regions'><img src='/static/img/buttons/features_button.png' class='child_row_button'></a>";
    }
    else {
        var BR = "<a class='moreInfoBtnLinkGrey_pa' title='Binding Regions'><img src='/static/img/buttons/grey_button.png' class='child_row_button'></a>";
    }
    // For MI: Cellular Components
    if (data[3] != '0') {
        var MI = "<a class='moreInfoBtnLinkMI' title='MimicINT Interfaces'><img src='/static/img/buttons/mimicint_button.png' class='child_row_button'></a>";
    }
    else {
        var MI = "<a class='moreInfoBtnLinkGrey_pa' title='MimicINT Interfaces'><img src='/static/img/buttons/grey_button.png' class='child_row_button'></a>";
    }
    // For AF: Cellular Components
    if (data[4] != '0') {
        var AF = "<a class='moreInfoBtnLinkAF' title='AlphaFold Complexes'><img src='/static/img/buttons/alphafold_button.png' class='child_row_button'></a>";
    }
    else {
        var AF = "<a class='moreInfoBtnLinkGrey_pa' title='AlphaFold Complexes'><img src='/static/img/buttons/grey_button.png' class='child_row_button'></a>";
    }
    var htmlText = "<div class='child_row_div'>"+PA+" "+CC+" "+BR+" "+MI+" "+AF+"</div>";
    return htmlText;
}

// For mimicint interfaces
function format_MI(d, bmIdIndex) {
    /**
...
function format_BR(d, bmIdIndex) {
    /**
...
function format_PA(d, bmIdIndex) {
    /**
     * Formatting the child Row when the user click on the green button corresponding
...
function format_CC(d, bmIdIndex) {
    /**
     * Formatting the child Row when the user click on the green button corresponding
     * to the protein_annotation informations. It uses Ajax to call some Php function
     * that execute the request.
    ...
    $.ajax({
        url: '../static/php/bactmenthaDB_library.php',
        data: {bmId: d[bmIdIndex], action: 'dispCellCompChildRow'},
        type: "GET",
        dataType:'text',
        success: function(response) {
        div.html(response);
...
// For alphafold complexes
function format_AF(d, bmIdIndex) {
    /**
     * Formatting the child Row when the user click on the green button corresponding
     * to the protein_annotation informations. It uses Ajax to call some Php function
     * that execute the request.
    ...
    $.ajax({
        url: '../static/php/bactmenthaDB_library.php',
        data: {bmId: d[bmIdIndex], action: 'dispAlphaFoldChildRow'},
        type: "GET",
        dataType:'text',
        success: function(response) {
        div.html(response);
